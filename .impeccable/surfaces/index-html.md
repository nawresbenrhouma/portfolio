...
OWN-WORLD: Near-white ground with a butter tint (#fffcf2) alternating with a warmer tone (#f6f2e6) section by section; pure white sheets lifted by a soft offset shadow (hairline ring in dark); espresso ink (#2b2417), warm brown-grey body text; one accent, butter yellow (#7a5a00) on the closing words of the name and every h2, links, the primary button, timeline markers, column icons and the selected folder tab, and as a surface in the hero panel. Dark: #1b170f / #201d17 alt / #332c1e sheets, cream text, light butter accent #f0cf5a with #f2c41f action. Faces: Gabarito 700/800 for display and headings; Source Sans 3 for text; Source Code Pro only in chips and status tokens. Radius 12px sheets, 8px controls, pills 999px. 8px module; content max 76rem.
